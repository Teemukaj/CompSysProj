...
void mpu9250_get_data(I2C_Handle *i2c, float *ax, float *ay, float *az, float *gx, float *gy, float *gz) {
    ...
    uint8_t accRawData[6] = {0, 0, 0, 0, 0, 0};
    uint8_t gyroRawData[6] = {0, 0, 0, 0, 0, 0};
    ...
    //int16_t nx = (int16_t)(((int16_t)AccRawData[0] << 8) | AccRawData[[1]) ;
    //int16_t ny = (int16_t)(((int16_t)AccrawData[2] << 8) | AccrawData[3]) ;
    //int16_t nz = (int16_t)(((int16_t)AccrawData[4] << 8) | AccrawData[5]) ;
    //int16_t mx = (int16_t)(((int16_t)GyroRawData[0] << 8) | GyroRawData[[1]) ;
    //int16_t my = (int16_t)(((int16_t)GyroRawData[2] << 8) | GyroRawData[[3]) ;
    //int16_t mz = (int16_t)(((int16_t)GyroRawData[4] << 8) | GyroRawData[[5]) ;
    readByte( ACCEL_XOUT_H, 6, &accRawData[0]);        // Read the six raw data registers into data array
    int16_t nx =(int16_t)(((int16_t)accRawData[0] << 8) | accRawData[1]) ;  // Turn the MSB and LSB into a signed 16-bit value
    int16_t ny = (int16_t)(((int16_t)accRawData[2] << 8) | accRawData[3]) ;
    int16_t nz = (int16_t)(((int16_t)accRawData[4] << 8) | accRawData[5]) ;

    readByte( GYRO_XOUT_H, 6, &gyroRawData[0]);       // Read the six raw data registers sequentially into data array
    int16_t mx = (int16_t)(((int16_t)gyroRawData[0] << 8) | gyroRawData[1]) ;  // Turn the MSB and LSB into a signed 16-bit value
    int16_t my = (int16_t)(((int16_t)gyroRawData[2] << 8) | gyroRawData[3]) ;
    int16_t mz = (int16_t)(((int16_t)gyroRawData[4] << 8) | gyroRawData[5]) ;
