...
Void uartTaskFxn(UArg arg0, UArg arg1) {
    ...
    while (1) {
        ...
        // Once per second, you can modify this (000000 / Clock_tickPeriod) is eqaul to 1s)
...
Void sensorTaskFxn(UArg arg0, UArg arg1) {
    ...
    while (1) {
        ...
        //System_printf("%lf", &data);
        char merkkijono[20];
        sprintf(merkkijono,"%lf\n",data);
        //System_printf(merkkijono);
        System_printf("sensortask tulostus lux-arvo: %s\n",merkkijono);
        //System_flush();
        ...
        //       Remember to modify state
        ambientLight = data;
        // Tilasiirtymä WAITING-> DATA_READY
